...
<table class="table">
    <tr>
        <td colspan="6" class="cart-title">Lịch sử mua hàng:</td>
    </tr>
    <%
        ArrayList<khthanhtoanbean> ds = (ArrayList<khthanhtoanbean>) request.getAttribute("lichsu");
    ...
    %>
                    <tr style="font-weight: bold; color: red;">
                        ...
                        Tổng tiền: <%= totalAmount %> VND</strong></td>
                    </tr>
    <%
                    totalAmount = 0;
                }
    ...
    %>
            <tr style="font-weight: bold; color: red;">
                <td colspan="7" style="text-align: right;"><strong>Tổng tiền: <%= totalAmount %> VND</strong></td>
            </tr>
    <%
        }
    %>
